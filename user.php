            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#featured">Güzergahlarım</a></li>
                        <li><a href="#projects">En Yeni Rotalar</a></li>
                        <li><a href="#blog">Liderler</a></li>
        ...
        <div class="slider">
            <div class="Modern-Slider content-section" id="top">
                ...
                <div class="item item-1">
                    ...
                    <div class="info">
                        <div>
                          <h1>Serbest Stil Koşu</h1>
                          <p>Birden fazla güzergah, birbirinden farklı heyecan. Hepsi burada!</p>
                          <div class="white-button button">
                              <a href="#projects">En Yakın Koşulara Bakın</a>
                          </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="item item-2">
                    <div class="img-fill">
                        ...
                        <div class="info">
                        <div>
                          <h1>Lütfen bu deneyimini <br>arkadaşlarına anlat</h1>
                          <p>Sosyal medyadan bizi takip ederek veya bizi etiketleyerek paylaşım yaparsan,
							<br>çok teşekkür ederiz.</p>
                          
                          <div class="white-button button">
                              <a href="#featured">Paylaş</a>
                          </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="item item-3">
                    <div class="img-fill">
                        ...
                        <div>
                          ...
                          <p>İstek ve önerileriniz için bizlere mail yoluyla ulaşabilirsiniz.</p>
        ...
        <div class="page-content">
            <section id="featured" class="content-section">
                ...
                <div class="section-heading">
                    <h1>Koşu<br><em>Güzergahlarım</em></h1>
                    <p>Sırasıyla bitirmeniz gereken rotalar,
                    <br>rota iptali için iletişeme geçiniz.</p>
                </div>
                        ...
                        <div class="item">
                            <div class="image">
                                ...
                                <div class="featured-button button">
                                    <a href="rotalarım.php">Listeyi Getir</a>
                                </div>
                            </div>
                            <div class="text-content">
                                <h4>Bütün Rotalarım</h4>
                                <span>Listeyi Getir Butonuna Tıklayınız</span>
            ...
            <section id="projects" class="content-section">
                <div class="section-heading">
                    <h1>En<br><em>Yeni Rotalar</em></h1>
                    <p>Duyurulardan ve yeniliklerden ilk sen haberdar ol, 
                    <br>hızlı adımlarla üye olup bu ayrıcalıktan yararlanabilirsin.</p>
                </div>
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
            ...
            <section id="blog" class="content-section">
                <div class="section-heading">
                    <h1>Koşu<br><em>Liderleri</em></h1>
                    <p>Hangi  güzergahta koşacağına karar veremediysen, 
                    <br>liderlerin bilgileri sana yardımcı olur.</p>
                </div>
                <div class="section-content">
                    <div class="tabs-content">
                        <div class="wrapper">
                            <ul class="tabs clearfix" data-tabgroup="first-tab-group">
                              <li><a href="#tab1" class="active">Batuhan Ankara</a></li>
                              <li><a href="#tab2">Rümeysa Özgür</a></li>
                              <li><a href="#tab3">Abdulkadir Aldemir</a></li>
                              <li><a href="#tab4">Rıdvan Yılmaz</a></li>
                            </ul>
            ...
            <section id="contact" class="content-section">
                ...
                <div id="contact-content">
                    <div class="section-heading">
                        <h1>Bizimle <br><em>İletişime Geç</em></h1>
                        <p>Buradan bize mesajını yollayabilir veya istek ve önerilerini paylaşabilirsin.
                    ...
                    <div class="section-content">
                        <form id="contact" action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                  <fieldset>
                                    <input name="email" type="email" class="form-control" id="email" placeholder="Eposta..." required="">
                                  </fieldset>
                                </div>
                                 <div class="col-md-4">
                                  <fieldset>
                                ...
                                <div class="col-md-12">
                                  <fieldset>
                                    <button type="submit" id="form-submit" class="btn">Gönder</button>
                                  </fieldset>
                                </div>
                            </div>
                        </form>
            ...
            <section class="footer">
                <p>Copyright &copy; 2021 Batuhan Ankara</p>
            </section>
        </div>  
